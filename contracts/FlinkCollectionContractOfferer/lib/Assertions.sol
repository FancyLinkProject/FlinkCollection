...
import {OrderParametersWithTokenInitializeInfo} from "./ConsiderationStructs.sol";
    ...
    TokenTransferrerErrors
{
    ...
    function _assertConsiderationLengthAndGetOrderHash(
        ...
        _assertConsiderationLengthIsNotLessThanOriginalConsiderationLength(
            orderParametersWithTokenInitializeInfo.consideration.length,
            orderParametersWithTokenInitializeInfo
        ...
        orderHash = _deriveOrderHash(
            orderParametersWithTokenInitializeInfo,
            _getCounter(orderParametersWithTokenInitializeInfo.offerer)
        );
    }
